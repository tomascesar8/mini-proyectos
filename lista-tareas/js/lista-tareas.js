...
ingresarTarea.innerHTML = `
    <form id="form-tarea" onsubmit="agregarTarea(event)">
        <fieldset>
            <legend>
                <h2 class="mb-4 w-100 text-white text-center fw-bolder" for="input-tarea">LISTA DE TAREAS</h2>
                <textarea id="input-tarea" class="mb-2 form-control" cols="40" rows="3" type="textarea"></textarea>
